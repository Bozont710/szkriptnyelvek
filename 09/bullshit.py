...
array1 = ["Erõforrás-alapú megközelítéssel kell",
...
array3 = ["a közösségi normáknak megfelelõ", 
"a decentralizált", 
...
def getResult():
	...
	index3 = round(random.random() * max3)	
	index4 = round(random.random() * max4)
	print(f"{array1[index1]} {array2[index2]} {array3[index3]} {array4[index4]}")
#ENDgetResult
